...
import com.example.case_study.services.ServiceService;
import com.example.case_study.services.ServiceTypeService;
import com.example.case_study.services.impl.ServiceServiceImpl;
...
//        model.addAttribute("divisionList", divisionService.findAll());
    ...
    public String createService(@ModelAttribute Service service, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("successMsg", "Create Employee: "+service.getServiceName() +" success!");
...
//        model.addAttribute("positionList", positionService.findAll());
    ...
    public String editEmployee(@ModelAttribute Service service, RedirectAttributes redirectAttributes){
        serviceService.save(service);
        redirectAttributes.addFlashAttribute("successMsg", "Update Employee: "+service.getServiceName() +" success!");
        return "redirect:/service";
    }
