...
<body>
<div class="row">
<div style="position: fixed;z-index: 9;margin: 0 ;width: 100%" class="col-md-12">
...
<%--Body--%>
<div style="position: relative;top: 135px" class="col-md-12">
    <%--Body-left--%>
    ...
    <%--Body right--%>
    <div class="card; col-md-9" style="width: 81%; margin-left: 18rem ; height: 115%">
        ...
        <div align="center">
            ...
            <table id="nhanvien" class=" table table-sm table-striped table-bordered">
                <thead>
    ...
    <%--Footer--%>
    <div class="card; col-md-12" style="margin-top: 0%" >
